...
float channelDisplacement; float tmp_6; float displacement; vec4 viewVertex; vec3 displacedVertex; vec3 modelVertex; vec3 vnormal; vec3 modelNormal; mat4 jitteredProjection; vec3 viewNormal; vec3 displacedNormal; vec2 gradientDisplacement; vec2 tmp_28; vec4 modelTangent;
...
displacedVertex = modelVertex + vnormal * displacement;
...
displacedNormal = bumpMap( modelTangent, vnormal, tmp_28 );
