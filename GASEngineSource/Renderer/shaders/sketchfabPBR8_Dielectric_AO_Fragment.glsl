...
tmp_23 = texture2D(Texture1, vTexCoord0).r;
...
tmp_52 = tmp_2.rgb*floatWhite;
if(uOutputLinear == 1 ) {
tmp_53= tmp_52;
} else {
tmp_53 = linearTosRGB( tmp_52 );
}
gl_FragColor = encodeRGBM( tmp_53, uRGBMRange );
