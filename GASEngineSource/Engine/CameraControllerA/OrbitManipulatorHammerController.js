GASEngine.OrbitManipulatorHammerController = function(manipulator)
{
    this._manipulator = manipulator;
    this.init();
};

GASEngine.OrbitManipulatorHammerController.prototype =
{
    init: function()
    {
    ...
    setEventProxy: function(proxy)
    {
        ...
        this._cbPinchInOut = function(event)
        {
            ...
            var minDezoom = 0.0;
            var maxDezoom = 0.5;
            zoomFactor *= smoothStep( minDezoom, maxDezoom, -Math.abs( event.velocity ) + ( minDezoom + maxDezoom ) );
