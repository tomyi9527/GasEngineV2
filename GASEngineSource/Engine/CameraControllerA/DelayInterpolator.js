GASEngine.DelayInterpolator = function(size, delay)
{
...
GASEngine.DelayInterpolator.prototype =
{
    ...
    update: function(dt)
    {
        ...
        //else
        //{
        //    this.isDone(100) ? o.a.draw() : o.a.drawNoJitter();
        //}
    ...
    isDone: function(e) 
    {
        ...
        for (var i = 0; i < this._current.length; ++i)
        {
            if(Math.abs(this._target[i] - this._current[i]) > e * this._epsilon)
            {
                return false;
            }
        }
