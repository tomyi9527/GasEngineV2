GASEngine.AutoPilotManipulatorStandardMouseKeyboardController = function(manipulator)
{
    this._manipulator = manipulator;
    this.init();
};

GASEngine.AutoPilotManipulatorStandardMouseKeyboardController.prototype =
{
    init: function()
    {
        //this.releaseButton();
