(function()
{
    ...
    // let arr1 = [1,2,3,4];
    // let arr2 = [3,4,5,6];
    // // 交集：2个元素重叠的部分.a1∩a2 = [3,4];
    // // 并集：2个元素合并.a1∪a2 = [1,2,3,4,5,6];
    // // 差集：减去重叠的部分.a1?a2 = [1,2,5,6];

    // console.log('差集');
    // console.log(_Math.differenceSet(arr1, arr2, valueHandler));

    // console.log('交集');
    // console.log(_Math.commonSet(arr1, arr2, valueHandler));

    // console.log('并集');
    // console.log(_Math.intersectionSet(arr1, arr2, valueHandler));

    // let arr1 = [1,2,3,4];
    // let arr2 = [2,4,3,1];
    // console.log('集合是否相等：' + _Math.isSetEqual(arr2, arr1, valueHandler));
