#pragma once
// pblock type definations from 3dsmax sdk 2019
// 
// Parameter types
...
enum ParamType2 {
    ...
    TYPE_RESERVED_1,			// needed for maintaining value for TYPE_POINT2, which was made a pblock2 parameter type
    TYPE_RESERVED_2,			// in an earlier release for MR support. Don't think that there are any scene files 
    TYPE_RESERVED_3,			// containing TYPE_POINT2 pblock2 parameters, but playing it safe....
    TYPE_RESERVED_4,			// note that these slots can be repurposed for pblock2 parameter types later
    TYPE_RESERVED_5,
    TYPE_RESERVED_6,
    ...
    // all ParamType values for pblock2 parameter types should be sequential here, so 
    // reserving room for future additions
    TYPE_RESERVED_7,
    TYPE_RESERVED_8,
    TYPE_RESERVED_9,
    TYPE_RESERVED_10,
    ...
    TYPE_RESERVED_1_TAB,			// needed for maintaining value for TYPE_POINT2_TAB
    TYPE_RESERVED_2_TAB,
    TYPE_RESERVED_3_TAB,
    TYPE_RESERVED_4_TAB,
    TYPE_RESERVED_5_TAB,
