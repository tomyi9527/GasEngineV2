...
#define SHADER_NAME Matcap_Blend(Material_10)
...
float getMaterialOpacity() {
    ...
    alpha = (texture2D(Texture0, vTexCoord0).a);
...
void main() {
    ...
    if (alpha == 0.0 || (uDrawOpaque == 1 && alphaFinal < 9.9999e-1) || (uDrawOpaque == 0 && alphaFinal >= 9.9999e-1)) discard;
