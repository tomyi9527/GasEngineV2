(function () 
{
    ...
    mgs.assign('classInherit', function(sub, supper, namespace)
    {
        let subName = sub.name;
        mgs.assign(subName, sub, namespace);
...
(function ()
{
    ...
    Object.prototype.onDestroy = function()
    {
    };

    Object.destroyObject = function(obj)
    {
        obj.onDestroy();
    };
}());
